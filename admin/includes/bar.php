<div class="wrapper">
        <nav id="sidebar" class="active">
            <div class="sidebar-header">
                <img src="https://www.flaticon.com/free-icon/admin_9322127?term=admin&page=1&position=2&origin=search&related_id=9322127" alt="bootraper logo" class="app-logo">
            </div>
            <ul class="list-unstyled components text-secondary">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="authmenu">
                        ...
                        <li>
                            <a href="../admin/auth/register.php"><i class="fas fa-user-plus"></i> Signup Admin</a>
                        </li>
                        <li>
                ...
                <li>
                    <a href="contactUs.php "><i class ="fas fa-envelope"></i>ContactUs</a>
                </li>
            </ul>
        </nav>
                            ...
                            <div class="nav-dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right nav-link-menu">
                                    <ul class="nav-list">
                                        ...
                                        <div class="dropdown-divider"></div>
                                        <li><a href="../admin/auth/logout.php" class="dropdown-item"><i class="fas fa-sign-out-alt"></i> Logout</a></li>
                                        /ul>
                                </div>
                            </div>
                        </li>
